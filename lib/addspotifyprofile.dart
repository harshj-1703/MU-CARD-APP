...
class AddSpotifyProfile extends StatefulWidget {
  const AddSpotifyProfile({super.key});

  @override
  State<AddSpotifyProfile> createState() => _AddSpotifyProfileState();
}

class _AddSpotifyProfileState extends State<AddSpotifyProfile> {
  @override
