...
class AddLinkedInProfile extends StatefulWidget {
  const AddLinkedInProfile({super.key});

  @override
  State<AddLinkedInProfile> createState() => _AddLinkedInProfileState();
}

class _AddLinkedInProfileState extends State<AddLinkedInProfile> {
  @override
